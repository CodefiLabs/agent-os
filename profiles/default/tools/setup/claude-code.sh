#!/usr/bin/env bash
# Claude Code MCP Tools Setup Script
# Installs MCP servers to Claude Code configuration
set -euo pipefail
...
Install MCP servers to Claude Code configuration.
